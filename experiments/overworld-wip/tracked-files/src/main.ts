...
function setupMobileControls() {
  ...
  controls.innerHTML = `
    ...
    <div class="mobile-actions" aria-label="Actions">
      ...
      <button type="button" class="touch-button action-button" data-touch-key="x" aria-label="Tool action">X</button>
      <button type="button" class="touch-button action-button" data-touch-key="e" aria-label="Use role ability">E</button>
      <button type="button" class="touch-button utility-button" data-touch-key="m" aria-label="Overworld map">M</button>
