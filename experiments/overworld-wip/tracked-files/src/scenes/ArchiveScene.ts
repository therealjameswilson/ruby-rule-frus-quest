...
export class ArchiveScene extends Phaser.Scene {
  ...
  private clearEnemy(definition: ArchiveEnemyDefinition, wall: BureaucraticWall, message: string) {
    ...
    wall.clear();
    playPackEffect(this, wall.position.x, wall.position.y, definition.type === "DANN-E QUEUE" ? "explosion" : "check");
    retroAudio.stamp();
  ...
  private applySourceNoteStamp() {
    ...
    playPackStampOverlay(this, this.researchTable.x + 20, this.researchTable.y - 16, "APPROVED");
    playPackEffect(this, this.researchTable.x, this.researchTable.y - 20, "sparkle");
