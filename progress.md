...
- Remembered cache directions (2026-09-13): A3/B3 now give short stage-aware objectives instead of generic room-code exploration text. A3 archivist interaction records archiveCacheClueHeard in existing sceneProgress, saves and refreshes the cue without awarding discovery: ASK ARCHIVIST -> CHECK LEFT SHELF -> CACHE: 2 SOUTH -> SOUTH: RETURN; B3 points north before discovery, south afterward, west after collection. Browser first exposed revealSecretRoom's generic-objective override; supported optional rooms now refresh after discovery. Four direction tests and final build pass. Full earned touch cache/clue-reload/discovery/collection/reload/return passes at 201 -> 207 clue -> 210 discovery -> 220 treasure, no duplicate rewards or browser errors. Native remembered-clue/return and standard Archive captures inspected at /private/tmp/frus-cache-clue-final/ and /private/tmp/frus-cache-clue-standard/. No deployment; physical-device and unaided enjoyment remain unverified.

- Optional treasure flow (2026-09-13): verified later earned A1 checkpoint holds Concurrence Slip and 201 points, then completed touch B1/B2/B3/A3 clue/shelf/C3 cache/Continue/north return. Initial NARA checkpoint was wrong for this harness and ended at a scene-wait timeout; no game failure implied. Cache/well rewards retain their existing visual celebration but no longer add a redundant blocking SECRET dialogue. Finished rewards retire their interaction immediately and on restored rendering; stale callbacks remain award-safe with a toast. Cache pickup label now names FRUS fragment, not Lore card. Added two live-handler tests and touch assertions for explore mode, immediate movement, retired interaction, saved reward and no repeat points (201 -> 220 -> 220). Final native captures inspected at /private/tmp/frus-cache-quiet/; standard main Archive client inspected at /private/tmp/frus-cache-standard/. Full 227 files / 1,712 tests and build pass; local only. Follow-up: A3/B3 still expose generic room-code objectives, visible in this route. Physical-device/unaided enjoyment unverified.

- Optional detour keeps main task (2026-09-13): fresh earned A1 touch exploration could not enter B1 because Concurrence Slip is correctly required, but the failed gate permanently replaced PICK UP SOURCE NOTE with the lock requirement. Generic tool-gate and unrevealed-secret rejection now refresh the current room task and show the requirement as a temporary toast; no lock changes. Added handler regression plus --blocked-detour earned-touch QA proving A1/20 points retained, task preserved after message expiry, and movement away from the gate. Native gate and standard Archive pickup/movement inspected in /private/tmp/frus-detour-task-preserved/ and /private/tmp/frus-detour-standard/. Two focused tests, build and diff check pass. The attempted early --cache-loop was a terminal prerequisite failure, not proof of the later cache route; that route still needs a current earned Concurrence Slip checkpoint. No deployment; physical-device/unaided enjoyment unverified.

- Guide gate walking cue (2026-09-13): reward screenshot showed SOUTH: ARCHIVE repeated beside an action-button badge despite a walk-through exit. HUD now separates destination from WALK THROUGH OPEN GATE with a notice badge while approaching; reachable interactions, counter coaching, dialogs and other scenes keep their existing priorities. English/Spanish/French cues fit unclipped. 23 focused HUD tests and build pass. Fresh touch opening/cue-led practice/reward/Continue/Archive QA passes with actual rendered cue assertion and no browser errors; native reward and standard Guide captures inspected in /private/tmp/frus-guide-walking-cue/ and /private/tmp/frus-guide-cue-standard/. Local only. Broader physical-device and unaided enjoyment evidence still needed.

- First fragment reward feedback (2026-09-13): collecting Front Matter after the earned practice counter now leaves a separate native reward icon visible, lifting 18px on snapped positions and fading after one second. Ownership/10 points/gate objective update immediately; no dialogue, movement lock or extra press. Unit test checks one-time award/reveal, snapped tween and cleanup. Fresh 375x667 touch opening with cue-led counter passes harmless miss, pause, returned bolt, visible reward plus immediate movement, repeated-interaction protection, saved Guide reload and Archive entry. Native reward and standard-client Guide captures inspected in /private/tmp/frus-guide-reward-reveal/ and /private/tmp/frus-guide-reward-standard/. Full 226 files / 1,708 tests and build pass (existing chunk-size warning). Local only. Next: review repeated HUD direction text; physical-phone and unaided fun still unverified.

- Veteran compiler art (2026-09-13): imported original AI-assisted silver-haired/ruby-jacket pose board into the current compiler art family; old sheet preserved, registry key/save/physics unchanged. First light-backdrop import left checkerboard specks, inflating bounds and shrinking the character; source-specific neutral-gray threshold now removes them. Source frame14 was backward; runtime approval14 uses source15, while runtime15 stays blank. Actions remain subdued placeholders for interaction/reading/approval, documented rather than claimed pose-perfect. Added actual registered veteran PNG alpha/scale/feet test and four-direction movement/texture/pixel-snap checks to earned replay QA. 26 sprite tests, build and diff check pass; earned touch New Game+ start/reload + four-direction keyboard movement pass without browser errors. Native captures inspected at /private/tmp/frus-veteran-refresh-clean/; standard main-compiler client also inspected. No public deployment. Next: improve veteran action silhouettes; physical-phone and unaided enjoyment remain unverified.

- Earned replay entry (2026-09-13): new qa-completed-title uses published touch save, actual Ending Title button, New Game+ button, compiler confirmation and Office reload. Completion count remains, NG+ active, points0, no Proof Lens and null fresh certification. First harness expected a non-null fresh certification and was corrected to assert null; no runtime bug. Title/NG+ and fresh Office native captures inspected in /private/tmp/frus-completed-title-final/; no browser errors. QA-only syntax/diff checks pass; no build/runtime changes or deployment. Follow up veteran sprite visual-family/scale consistency seen in the Office capture; physical-phone and unaided fun unverified.

- Full touch finale after ownership fixes (2026-09-13): current earned pre-boss save replayed with --mobile --boast-skip --multitouch --disperse --cloud-imprecise. Colossus/Swarm/Cloud cleared in 55.721s instrumented loop, five cycles, zero retries, deadline not missed; bindery continuation persisted. Follow-on touch assembly passed seal cancellation/reload, five pieces, separate publication press and published reload. Final 241 points, publication record reliability100, deadlineMET, cover5/5, published clean; no browser errors. Native Cloud/published/record captures inspected in /private/tmp/frus-owned-full-boss/ and /private/tmp/frus-owned-publication/. QA-only; no runtime edit or deployment this pass. Timing is automated loop timing, not novice play time. Physical-device and unaided enjoyment still unproven.

- Expansion tool ownership (2026-09-13): DanneMapScene ordinary strikes now use the shared owned-combat-tool gate; separately owned Ruby Pen path is preserved. Missing tools show a short toast, with no free normalized Stamp swing. Hidden passage already checks Folder ownership. Unit handler test covers missing/noncombat/unowned and earned Folder. Browser no-tool check now covers both map families, then valid menu swap. Earned touch boss opening passed two-finger input, boast skip and uneven counters (Colossus HP180->152, one returned bolt, reliability98->58); not a full fight. Native blocked/core and standard NARA captures inspected in /private/tmp/frus-expansion-owned-swing/, /private/tmp/frus-owned-tool-boss/. Build and 226 files / 1,706 tests pass. No public deployment; real-device/unaided enjoyment unverified.

- Map tool ownership (2026-09-13): GameplayMapScene called Player.startAction directly, allowing null/nonweapon slots to normalize to a free Stamp. It now uses shared tryEquippedToolSwing like main chapters and gives EQUIP AN OWNED TOOL without starting a swing. Scene tests cover null/noncombat/unowned rejection and owned success. Browser qa-swing-menu-identity first checks unchanged swingId on empty inventory, then valid Folder/menu/Pencil sequence; native blocked and standard client captures inspected in /private/tmp/frus-owned-swing/. Build and 226 files / 1,705 tests pass. No input map, timing, save or room-gate changes; no deployment. This closes an ownership omission found while auditing navigation/control hints.

- Live mid-swing menu swap (2026-09-13): source audit confirmed boss core, projectile and hidden-passage checks already use the captured weapon tool. Added qa-swing-menu-identity to exercise a real Folder swing, pause during windup/active, mouse-equip Pencil, resume and start next swing. Passive enemy-check argument observer proves Folder retained then Pencil used; no browser errors. Menu and next-swing native captures inspected in /private/tmp/frus-swing-menu-identity/. Debug-granted tools, not earned progression or damage proof. QA-only; node syntax/diff checks pass, runtime build/test result unchanged from prior turn. No deployment; physical-device and unaided enjoyment remain unproven.

- Victory-to-exploration handoff (2026-09-13): NARA completion screenshot showed clipped ROOM CLEARED text and leftover USE CITE advice. First clear now sets ROUTES OPEN; cleared-room HUD advice becomes EXPLORE OPEN ROUTES with nearby interactions retaining priority. English/Spanish/French cues added. NARA's next objective is TO CATALOG DESK (the first longer revision still clipped, caught visually). qa-nara-waves now asserts the rendered objective and post-clear cue, then exits. Final native /private/tmp/frus-victory-handoff-final/exploration-handoff.png and standard NARA client inspected; two-wave/tool-swap browser run passed with debug-granted tools. Full 226 files / 1,704 tests passed before final string shortening; final build passes. No gate/reward/save changes or deployment. Physical-phone and unaided enjoyment remain unverified.

- Swing identity consistency (2026-09-13): GameplayMapScene passed currently equipped inventory tool to enemy hit checks while Player hitbox/VFX retained the tool captured at swing start. Damage checks now use the weapon controller's swing tool, preventing menu swaps from relabeling an in-flight attack. Three scene regressions cover a differing selected item for Stamp/Pencil/Folder; existing enemy tests retain correct/wrong-tool damage checks. Two-wave NARA browser replay with menu tool swap, route unlock and exit passed (/private/tmp/frus-swing-identity-waves/); debug-granted tools, not earned progression. Native cleared and standard movement/swing client inspected. Build and 226 files / 1,703 tests pass. No stats/save/cooldown changes or deployment; simultaneous mid-swing swap is covered by unit wiring tests, not the ordinary-wave browser run.

- Optional treasure payoff (2026-09-13): First Edition previously faded away in 400ms, leaving only +25 text. The existing animated book now rises above the hero over 240ms, holds visibly, then fades at 1140ms; no input lock or delayed save. Unit handler test covers one reveal, immediate save, pixel-snapped lift and cleanup. Earned touch QA asserts a visible book during actual movement, +25 once, safe NARA return and reload. A navigation harness failure three pixels off a two-pixel target was fixed with four-pixel touch route tolerance; exact doorway-edge fixtures unchanged. Final /private/tmp/frus-secret-reveal-movement-fixed/reward.png and standard NARA client inspected. Build and 226 files / 1,700 tests pass. Local only; real-device and unaided enjoyment remain unproven.

- Earned proof touch coverage (2026-09-13): qa-earned-proof now supports 375x667 DPR3 Chrome touch input and phone screenshots alongside keyboard. First replay exposed a harness mistake: the assumed floating D-pad origin touched the chronology board's left arrow, correcting the draft instead of selecting File. Use visible board buttons and assert the invalid board stays open. Corrected touch and keyboard runs pass reference/release rejection, chronology repair, Proof Lens reveal and saved production handoff with no browser errors. Native rejected/reloaded and phone reward screenshots inspected in /private/tmp/frus-touch-proof-corrected/; keyboard evidence /private/tmp/frus-keyboard-proof-recheck/. Earlier earned editor touch/reload also passed in /private/tmp/frus-current-editor-pass/. QA-only change; syntax and diff checks pass, runtime build/unit results remain the preceding 226 files / 1,699 tests. Physical-device and unaided enjoyment unproven; no deployment.

- Referral route alignment (2026-09-13): R1 east map incorrectly used small-key status despite earned Referral stamp opening actual door. Readout now checks stamp and gives manifest/treatment/press guidance. Unit draft/key/save cases added; 226 files / 1,699 tests and build pass. Current earned chain replayed dispatch/shelf shortcut, then touch manifest correction, guide hints, unfiled-treatment reload, wrong-facing press rejection, successful print, Concurrence Slip and proof arrival. QA asserts map closed before/open after print; native completion/proof captures inspected in /private/tmp/frus-referral-map-fixed/. Standard Referral client passed. No gameplay gate/schema/deployment changes; real-device and unaided enjoyment remain unproven.

- Vault return feedback (2026-09-13): shared carriedClassNetVaultDocket lookup aligns existing exit check with map restriction. N2 west now displays FILE while carrying and SPLIT immediately after final filing; pickup/final filing refresh gate art and traversal, no new restriction. Earned clearance QA asserts signs/map before/after, then passes missing-entry rejection, chronology repair, token, Referral arrival/reload. Native captures /private/tmp/frus-vault-return-fixed/ inspected, no errors. Unit valid/invalid docket and persistence tests; 225 files / 1,698 tests and build pass. Standard Network client passed. No save-schema change/public deployment/physical-phone or unaided-enjoyment claim.

- Network map gate (2026-09-13): earned touch routing reproduced false LOCKED after all four deliveries, while the actual vault door opened. Shared networkRoutingComplete now drives restore and map, preserving legacy Network stamps; map calls it a workflow gate with routing guidance rather than a small-key requirement. Added closed/closed/open assertions and console errors to mobile earned routing script. Before run failed, fixed run passed physical vault crossing/reload/movement; native completion and phone restored screen inspected in /private/tmp/frus-network-map-fixed/. Full 224 files / 1,696 tests and build pass; standard Network client passed. Next source-identified mismatch: N2 west door rendered open while carrying a docket though actual exit blocks. Local only; no physical-phone/unaided-fun proof or deployment.

- Earned gate payoff replay (2026-09-13): filed the carried annotation packet, collected both supporting documents and physically crossed east to Network. Extended qa-earned-network with held-stamp and closed/closed/open map assertions, earned-save requirement and console errors. Filing screenshot exposed stale west LOCK sign after packet restriction ended; completeAnnotationDrafting now redraws gates and syncs traversal immediately. qa-file-annotation asserts LOCK before and OFFICE after filing without reload; fixed native capture and Network arrival inspected. 224 files / 1,695 tests and build pass; standard Archive movement client passed. Evidence: /private/tmp/frus-packet-gate-filing-fixed/ and /private/tmp/frus-packet-gate-crossing/. Local scripted keyboard scope; no public deployment or physical-phone/unaided-fun claim.

- Map/door truthfulness (2026-09-13): found the east A1 map gate used Citation Stamp ownership while gameplay required a complete source packet/reviews. Shared archiveSourceRoomExitReady now drives scene readiness and restored map evidence; carried notes also mark west/east/south locked in readout and gate art, north stacks still available. Added completion/review/save/packet tests; 224 files / 1,694 tests and build pass. Corrected qa-pause-routes storage restoration: prior claimed earned fixture was actually a fresh debug room. New run uses Playwright storageState + normal start + held-stamp assertion and passes locked-east/open-west, input/back/resume with inspected captures in /private/tmp/frus-route-gate-earned/. Standard Archive client inspected. No schema, rewards or public deployment changes; physical all-edge traversal/unaided enjoyment still unproven.

- Pause route explanations (2026-09-13): current-room map line/confirm now opens named exits with live OPEN/LOCKED requirements; existing arrows cycle routes, Back returns to map before play, hidden destinations omitted. Overview location is bounded, full title wraps in detail. Actual overlay tests cover touch/confirm/back, live unlocked state and hidden-room exclusion; full 223 files / 1,691 tests pass. Earned Source Entry phone-sized Chrome check captures readable north gate/west route and verifies clean resume, no errors. Standard movement client/native screenshot inspected. Evidence/docs in PAUSE_ROUTE_DETAILS.md and /private/tmp/frus-pause-routes/. No gate/save changes or deployment; novice discoverability and physical-device testing remain open.

- Portrait demand loading (2026-09-13): defer NPC portraits to unlocked field-guide entries and variant stills to Black Vault/gallery. Codex init captures state and pauses parent before fetching, hides combat controls during loading, and skips requests on cached returns. Opening /assets/ bodies now 21,089,433 bytes, cumulative 73.2% reduction from 78,776,811; localhost samples are not mobile-network benchmarks. Eight fresh-route checks, delayed-portrait pause/dodge check and earned-touch boss opening to Swarm pass with inspected native captures. Full 223 files / 1,689 tests pass. No art edits, progression changes or public deployment. Remaining shared art ~21.1 MB; real-device and unaided enjoyment checks remain open.

- Startup payload reduction (2026-09-13): source scan found no literal unfinished main-route interaction, but Boot loaded all expansion paintings and unused original character reference sheets. Fresh-browser resource timing (buffer raised to 10,000) measured /assets/ bodies 78,776,811 -> 50,593,301 bytes, 35.8% deferred. Added shared-image registry subset; Boot retains runtime actors, individual map scenes load only their own painting, gallery retains original sheets/all maps. No assets removed/edited, gameplay/save unchanged. Eight isolated routes + native screenshots and standard NARA client passed; new live preload/cache tests, full 222 files / 1,687 tests, build pass (existing chunk warning). docs/STARTUP_ASSET_LOADING.md records scope, raw measurement paths and remaining 50.6 MB shared cost. Local only; not mobile-network speed/deployment proof.

- Live NARA/field-guide freeze regression (2026-09-13): added qa-codex-combat-pause.mjs. Debug fixture walks into drone windup, holds pause and codex 1.8s each, verifies identical positions/HP/tell, reads unlocked entry with touch, closes without swing/hit, then dodges with remaining window. Initial harness reliability-only dodge claim was invalidated by visible hit flash; corrected movement away from target and explicit before/after-movement invulnerability checks. Final /private/tmp/frus-codex-combat-pause-final/ passes, native list/detail/resume inspected, no console/page errors. Four legacy enemy classes have no production callers; no dead-code fixes made. Updated PAUSE_TIME_AND_RESUME with current scope/limits. QA-only, prior 1,685-test/build pass still latest; Node syntax passes; not physical iPhone/full-catalog/fun proof.

- Cue-led Archive review wording (2026-09-13): used screenshots and keyboard from earned opening save through three clues, readership correction, filing, standards decision and actual wall stamp. Found STAMP AT TABLE prematurely suggested a swing before the standards interaction. Now missing-rule state cues REVIEW AT TABLE / REVIEW CABLE / REVIEW terminal and review feedback; existing-rule state retains stamping wording, unchanged gates/rewards/save. Native cue-led endpoint /private/tmp/frus-cue-led-archive/; automated earned replay /private/tmp/frus-source-review-cue/ asserts objective and passes stamp/wall/stacks/reload/movement with no browser errors. Standard client/native captures inspected. 221 files / 1,685 tests and build pass; initial overlong wording was caught by existing HUD-clamp test and shortened. Familiar operator, not novice/physical-device/fun proof; local only.

- Pause-map orientation (2026-09-13): restored fresh cue-led Archive save in isolated 375x667/DPR3 Chrome. Current chapter map lacked the live task; now displays bounded two-line objective below dungeon status, with ellipsis for longer text and full objective still in Log. Other chapters/empty objective retain legend. No gameplay, gate or save changes. Current/other/live-update and wrap tests added; 221 files / 1,685 tests and build pass (existing chunk warning). Native before/after in /private/tmp/frus-map-current/ inspected, no page/console errors; standard Archive client also inspected. Room codes still need first-time-player comprehension feedback. Local only, no physical-device/fun-completion claim.

- Cue-led opening check (2026-09-13): fresh isolated browser, visible screenshots rather than route scripts/runtime positions guided Title -> compiler -> Office memo/inbox/stamp -> Guide. Direction cue plus four uneven X presses returned tutorial bolt; collected Front Matter, entered Archive. Endpoint only then read: PICK UP SOURCE NOTE,20 points,reliability71,Key/Stamp/FrontMatter; no page errors. Idle inspection time included; no console-error listener in this manual session. /private/tmp/frus-cue-led-opening/ stores endpoint image/result/earned save. Browser/repl closed; no changes to user save. Updated EARNED_PLAYTHROUGH_REVIEW; no runtime changes justified. Operator knows game, so this is not novice/physical-device/fun proof. Optional user question asks what most needs improvement. Prior build/1,683 tests remain latest verification; local only.

- Expansion-map walking mismatch fixed (2026-09-13): secret entrance edge probe failed at x214/y84 with no hit state. DanneMapScene's secondary walkability check still used 16px inclusive Rectangle intersection, undoing valid Player movement with 12px feet. Reused walkingFeetOverlap, retaining polygon containment. Secret entry trigger now derives x194..214 from actual opening and shared feet; outside overlap remains blocked. Added live map-handler clearance/boundary tests.
  - qa-reading-room-return.mjs now shares edge approach diagnostics and supports --edge-entry. Baseline /private/tmp/frus-secret-entry-before/ failed; keyboard right and touch left margins pass collection/return/reentry/no duplicate in /private/tmp/frus-secret-entry-{fixed,left-touch}/. These are debug fixtures. Shared Black Vault touch regression --boast-skip --multitouch --imprecise passed into Swarm HP124, reliability78, three returns, no retry/error: /private/tmp/frus-map-footprint-boss/. Not a full fight rerun. Native entry, standard NARA client and combat screenshots inspected. Full suite 221 files / 1,683 tests and build pass (existing chunk warning). Local only.

- Hidden-room off-center exit fixed (2026-09-13): actual keyboard right-edge approach x138 reached y222 but failed to return because secretReadingRoom still assumed old 16px feet. Trigger now uses shared 12px walking width, admitting x118..138 inside the unchanged 32px opening. Updated edge/outside tests. --edge-return reproduces before and passes after; touch --left-edge asserts x118 and also passes collection, return, revisit/no duplicate, save. Traces retain setup failures as distinct from gameplay failures.
  - Earned NARA checkpoint replay --mobile --natural-entry --escape-return passed actual Folder discovery, +25 First Edition, safe sidestep and saved one-entry reward (201->226), no errors. Fixed qa-earned-secret movement helper to stop on scene transitions; an initial harness failure was steering toward old NARA coordinates after already entering the room. Evidence /private/tmp/frus-secret-{edge-before,edge-fixed,left-edge-touch-final,current-earned-fixed}/. Native failure/fixed/reward/return and standard client screenshots inspected. Build passes with existing chunk warning; 220 files / 1,681 tests pass. docs/EXPLORATION_PLAYTEST.md updated. No deployment or physical-phone/unaided-fun claim.

- Current earned touch finale verified (2026-09-13): from /private/tmp/frus-current-production/earned-storage.json, boss run --mobile --boast-skip --multitouch --disperse --cloud-imprecise passed Colossus/Swarm/Cloud in 58.964s of instrumented loop, five cycles/four fresh hits, zero retries, no missed deadline. Uneven Cloud segment: 16 swings, three returns, HP180->96, reliability58->28. Actual two-pointer ownership, frozen dialogue/pause timing, unchanged documents/points and bindery reload asserted. /private/tmp/frus-current-touch-boss/.
  - Continued with qa-bindery-assembly.mjs --mobile: explicit seal cancellation/reload, five packets, separate publication press, 241 points, reliability100, clean publication and stable published-save stats; no page/console errors. /private/tmp/frus-current-touch-publication/earned-publication-storage.json is the completed checkpoint. Combat/Cloud, certification and published native images inspected. Updated docs/EARNED_PLAYTHROUGH_REVIEW.md with exact scope and limits. QA-only; prior build/1,681 tests remain latest compile/unit verification. No deployment. Next assess optional exploration and first-time cue comprehension rather than repeat only the critical path; full fun goal remains unproven.

- Restored visible editor/proof tool rewards (2026-09-13): earned screenshots showed Red Pencil and Proof Lens bursts were created before advanceAfterStamp cleared/redrew their room, destroying the payoff immediately. Spawn those bursts after advancement, hide the redundant transition toast (HUD retains next destination), position at (128,72), and opt into a 600ms hold before the existing fade. Other reward callers retain zero delay. No progression/reward/save changes or input lock.
  - Added live-handler ordering and repeat-press tests for both tools and an ordinary non-tool flag. Updated decision-test rendering doubles. Full suite 220 files / 1,681 tests and build pass (existing chunk-size warning). Standard client native proof-room screenshot inspected.
  - Extended qa-earned-editor.mjs with --mobile and --reload-bracket: actual touch-only repair, rejection of invisible deletion, unfiled bracket persistence, no premature tool/reward, filing/stamp and east exit pass. Both editor/proof QA scripts assert a live reward object survives redraw. Final captures inspected: /private/tmp/frus-editor-reward-final/pencil-earned.png and /private/tmp/frus-proof-reward-final/lens-earned.png; labels no longer overlap transition toast.
  - Current earned chain also passed reference correction, release-scope rejection, chronology repair, Proof Lens reload, production dockets, Buckram Key and final-vault arrival. Boss continuation checkpoint: /private/tmp/frus-current-production/earned-storage.json. These are instrumented browser checks, not unaided-human enjoyment or physical-device proof. Next play current boss/counter recovery through publication; local only.

- Earned clearance/referral regression (2026-09-13): continued the current Network touch checkpoint through the ClassNet review, deliberately rejected a missing chronology entry, repaired it, earned Clearance Token and entered R1. Extended qa-earned-clearance.mjs to require earned storage, capture console errors, reload at the referral handoff and assert room, completed review, token, unchanged points and resumed movement. Strengthened run passed: /private/tmp/frus-clearance-reload/; restored-room screenshot inspected.
  - Current earned dispatch exploration passed source-copy recovery, unapproved draft persistence, shelf-crank shortcut and return: /private/tmp/frus-current-referral-discovery/. Follow-on --mobile --guide-check --reload-treatment passed manifest correction, current NPC guidance, saved treatment draft, wrong-facing press rejection, actual stamp, Concurrence Slip and SilentRead arrival. Continue from /private/tmp/frus-current-referral-touch/earned-storage.json. Native ledger/shortcut and phone treatment/press images inspected; no captured browser errors. QA syntax check passes; no runtime changes or new build/unit claims this turn. Scripted Chrome touch is not physical-phone or unaided-human proof. Local only.
...
- Fixed a real Annotation Stacks side-push blocker (2026-09-13): earned touch run stopped at player (113,111), cart (128,112), because push detection still used the old 16px feet and minimum horizontal separation 16. Player terrain feet are 12px wide. Cart contact now uses walkingFeetOverlap and derives side clearance from the shared feet width, rejecting embedded positions and wrong-direction pressure. Added the exact failed position as a regression test.
  - Desktop repeat also passed the full cart/notes/return route and mid-puzzle reload: /private/tmp/frus-annotation-cart-desktop-fixed/. This is earned scripted play, not unaided human or physical-device proof.
  - Added tools/qa-earned-annotation.mjs with earned-checkpoint inputs, keyboard/touch adapters, native/phone captures and --reload-cart. The original failure is retained in /private/tmp/frus-annotation-cart-touch/. Fixed touch run passed north pushes, mid-puzzle reload, right push into bay, three note pickups and return to A1; /private/tmp/frus-annotation-cart-touch-fixed/ native/phone parked screenshot inspected. Full suite 218 files / 1,676 tests passes; build passes (existing chunk warning). Standard Archive browser render inspected. No auto-parking, granted progress, save-schema change or deployment.

- Consistent process-wall motion (2026-09-13): earned A1 audit showed the source-note wall already clears on the first swing, so no interaction/difficulty bypass was added. Code inspection found frame-dependent linear-follow clamping and movement on zero elapsed time. BureaucraticWall now uses an elapsed-time compounded follow factor that preserves the existing 60Hz response, with the shared 50ms stall cap. Tests cover every wall speed at 30/60/120/144/240Hz and zero/negative/stalled updates.
  - Tightened qa-earned-source-note.mjs from twelve retries to three and record wall-clear.json attempts/swings. Updated earned run passed provenance clues, rejected/corrected source-note draft, human standards decision, physical stamp, one-attempt/one-swing wall clear, Annotation Stacks entry and reload. Evidence /private/tmp/frus-source-wall-follow/; route-open native screenshot inspected. Standard client Archive render inspected too. Full suite 218 files / 1,675 tests passes; build passes with existing chunk warning. No device FPS/performance claim or deployment.

- Interaction clarity (2026-09-13): replaced the three filled/pulsing target rectangles with eight static one-pixel corner arms, leaving the document/NPC artwork uncovered. Removed label bobbing and fractional highlight scaling. No changes to interaction selection, range, input or rewards. Added drawing/lifecycle tests covering clear center, whole-pixel coordinates, stationary labels and hide/destroy behavior.
  - Build passes (existing chunk-size warning); full suite 217 files / 1,662 tests passes. Standard Archive client screenshot inspected. Earned Archive save at simulated phone 375x667/DPR3 verified stable placement over 500ms and touch-A pickup of Source Note 47; native and phone screenshots inspected under /private/tmp/frus-clean-target/, result.json records unchanged scale and successful pickup. Other room-label/art clutter remains; no broad visual-completion claim. Local only.

- Skill-based lurker recovery (2026-09-13): returning an Ego bolt into DANN-E now restores at most 2 reliability of actual recorded lurker combat loss and stuns him. Direct swings and merely reflecting a bolt grant no healing. Quest healing retires the same combat balance, preventing banked credit from repaying later editorial penalties. Standards records, document decisions, inventory and final-boss recovery remain unchanged; the balance uses existing persisted sceneProgress.
  - Repeatable script passed with reliability 74 -> 76 and recovery balance 6 -> 4; inventory and document points unchanged. Evidence: /private/tmp/frus-lurker-recovery-final/recovery.json and returned.png (inspected). This proves the interaction, not long-run balance or beginner success rate.
  - Added live reliability integration tests for full/partial quest healing, repeat-return protection and unchanged standards ledger, plus actual lurker projectile tests for reward timing. Full suite: 216 files / 1,660 tests pass; production build passes with existing chunk-size warning. Earned Archive browser run observed damage then a successful 2-point return, after several failed attempts; /private/tmp/frus-lurker-recovery/ native screenshot inspected. Added tools/qa-lurker-recovery.mjs to reproduce with an earned checkpoint. Standard client Archive render also inspected. Local only; no deployment or physical-phone claim.

- Player movement polish (2026-09-13): doorway corner guidance now spends the remaining movement budget on forward travel as soon as the feet clear the edge, eliminating the extra stopped frame without increasing walking speed or expanding the assist radius. Walking frames advance with actual distance traveled and preserve stride phase across turns; idle and tool animations remain separate. No input, inventory or save schema changes. Existing unfinished DANN-E recovery edits were left untouched.
  - Follow-up touch-only earned opening passed at 375x667/DPR3: Warning/Title/Compiler, office assignment and memo, both training-room wall limits, wrong-facing cue, harmless missed bolt, pause/resume without accidental swing, coached return, fragment pickup, reward-repeat protection, reload and Archive entry. Phone counter screenshot inspected. Evidence: /private/tmp/frus-stride-opening-touch/results.json and earned-storage.json. This is simulated Chrome touch, not real iPhone testing or proof of unaided novice enjoyment.
  - Focused movement coverage includes same-frame fractional corner clearance at 30/60/120Hz, bounded travel, weighted stride and direction-change animation continuity. Full suite: 215 files / 1,657 tests pass. Production build passes (existing large-bundle warning). Standard Chrome client exercised Office cardinal/diagonal movement, reversal and release; native screenshot inspected, no console-error artifact. Evidence: /private/tmp/frus-stride-qa/ and /private/tmp/frus-player-client-native/native.png. Local only; no physical-device or public-deployment claim.

- Opening mission clarity (2026-09-13): fresh desktop opening audit passed through harmless counter miss, pause/resume, returned bolt, Front Matter reward and Archive entry. Screenshots showed the first assignment stating only memo/inbox/stamp instructions. First Junior Compiler conversation now uses the same non-blocking toast to state PUBLISH A FRUS VOLUME; latest message connects threatened records to reliable publication. HUD/arrow still directs TAKE THE MEMO. Repeat conversations retain practical routing advice, with no new click, reward or save schema.
  - Added live Office handler test for first/repeat behavior and unchanged inventory/points (13 focused tests pass); build passes. Fresh touch-only opening with coaching passed through Archive after change, including no-damage miss and paused projectile; /private/tmp/frus-opening-mission-touch/. Phone mission screenshot and standard-client native image inspected. Desktop baseline /private/tmp/frus-fresh-opening-current/. This verifies guided automation, not unaided novice comprehension. Local only.

- Evidence-based treatment instead of two automatic deliveries (2026-09-13): a compact two-field board now pairs fictional evidence (foreign consent pending; whole document withheld) with an initially wrong PRINT/OMIT draft. Player repairs to HOLD/APPEAL and explicitly files at the permission station. This records the existing permission and appeal stages together, removing the appeal desk trip, then hands over the bracket proof for the existing physical Citation Stamp finish. Legacy step-one saves can enter at the appeal station. No release consent is inferred.
  - Draft edits persist separately in numeric sceneProgress.referralTreatmentDraft; invalid save values restore an unapproved draft. Cancel does not file; player and DANN-E pause during review. Added treatment-specific HUD cue and touch/keyboard board controls. Existing rewards, completion flags and physical stamp gate remain intact.
  - Full suite 215 files / 1,651 tests and build pass. Earned keyboard run under /private/tmp/frus-treatment-draft/ and touch-only run at 375x667 under /private/tmp/frus-treatment-draft-touch-final/ both reach proofing. Touch run rejects wrong/half-corrected drafts, closes corrected draft, reloads it with treatment still at step0, files, stamps, and checks repeat-hit points. Guide harness waypoint moved inside interaction radius after a near-edge test miss. Native/phone rejected-board and standard-client images inspected; no browser errors on successful runs. Local only, not physical iPhone or novice-fun verification.

- Touch-only physical press route (2026-09-13): added --mobile to qa-earned-referral-manifest.mjs with real CDP touch events for all movement, board navigation, confirmation and B swings at 375x667/DPR3. Captures native and full-phone images and checks console errors. No keyboard inputs on the mobile path.
  - First harness stalled on an unnecessarily precise waypoint despite an available appeal prompt; phone movement now uses 5px tolerance and gestures >=50ms. Second run exposed the recovery script assuming no enemy knockback after its deliberate miss. It now walks back below the press before inspecting/retrying. No runtime collision or damage changes warranted.
  - Final run passed wrong draft rejection/correction, Marcus help, treatments, away-facing miss, re-approach, physical stamp, repeat-hit reward protection, Slip pickup and proofing arrival. /private/tmp/frus-bracket-touch-recovery/ contains earned storage and screenshots; rejected-draft and gate-open phone images inspected. This is simulated Chrome touch, not physical iPhone or unaided-human usability proof. QA-only changes; previous 1,640-test/build pass remains prior verification. No deployment.

- Physical bracket-press payoff (2026-09-13): final referral treatment now requires an active Citation Stamp swing contacting the press while carrying the reviewed excision proof. A inspects/orients and explains the visible withholding marker; it no longer auto-files this last docket. Owned tool, reviewed manifest, step and carry guards prevent bypass; wrong tools give feedback without a reliability penalty. Reuses existing swing timing/VFX, reward burst, completion/save logic and gate. The marker does not release hidden text.
  - Added referralBracketStrike pure tests for missing prerequisites, inactive/away-facing contact and wrong tools. Updated objective/guide/inspection cues. Full suite 214 files / 1,640 tests and build pass. Standard client native image inspected.
  - Earned browser route passed twice through proofing entry. Second run deliberately swung away (no progress), inspected again to face press, stamped, and repeated swing (no duplicate document points). Evidence /private/tmp/frus-bracket-strike/ and /private/tmp/frus-bracket-recovery/; press-ready and gate-open native screenshots inspected. No page errors. Touch button uses the existing B swing path, but this new press has not yet had its own touch-specific check. Local only.

- Stage-correct referral help (2026-09-13): fixed the empty-handed treatment hint inherited from equity-stage copy; it now sends players to the review tray and treatment station, not back north to finished dispatch discovery. Added coverage across all three treatment steps and both dispatch flag values. Extended qa-earned-referral-manifest.mjs with --guide-check: after filing, walk to Marcus, ask, assert correct message/objective and unchanged points/treatment/carry state, then complete treatment and earn Slip/proofing entry.
  - Earned browser route passed under /private/tmp/frus-treatment-guide/; treatment-guide screenshot and standard-client native image inspected. Focused suite 32 tests passed; build passed with existing chunk warning. No new save fields, rewards, release approvals or deployment. Next design work remains making treatment decisions physical and consequential rather than automatically filing by station label; do not auto-award permission/appeal evidence to shorten play.

- Discovery-prepared referral batch (2026-09-13): carrying the batch to the original Dispatch Stacks receipt now prepares the draft, replacing three mandatory desk deliveries on the preferred route. It does not grant approval, a stamp, or release. Original agency desks remain usable; human correction/filing, treatments and Concurrence Slip still gate progression. Updated arrival, guide, pickup and objective cues to consistently point north.
  - Current browser route passed from earned Clearance save: pickup, north stacks, receipt, repeat-interaction protection, draft reload, crank shortcut, return. Follow-up rejected wrong WH Minutes routing, corrected CIA to NSC, filed, completed treatment, earned Slip and walked into SilentRead. Evidence: /private/tmp/frus-discovery-final/ and /private/tmp/frus-discovery-final-filed/. Native draft/rejection and standard-client guidance screenshots inspected; no captured page errors.
  - Final focused referral tests: 36 passed; production build passed with existing chunk warning. Full suite immediately before final copy edits: 213 files / 1,634 passed. No public deployment or unaided-human fun claim. Next: assess treatment-station repetition and novice comprehension.

- Player passage clearance (2026-09-13): narrowed walking feet from 16x8 to 12x8 without changing sprite size, speed, save schema, or input. Strict overlap allows flush wall contact; a 16px passage now has two pixels of steering clearance per side. Shared collision checks also preserve knockback/corner safety. Added all-edge contact and narrow-passage tests; focused movement suite 53 tests passes and production build passes (existing chunk warning). Standard browser client exercised Office movement/diagonals/reversal/release; native screenshot inspected, no client errors. Evidence: /private/tmp/frus-feet-clearance/. Existing referral edits left untouched; no deployment.
...
- Earned editorial and proofing handoff (2026-09-13):
  ...
  - Played S1 from that earned save: selected and filed wrong OpenNet reference (specific type/date hint), corrected to Document 18, stamped; rejected printing beyond released section B, corrected A/C to HOLD, filed and stamped; retained the wholly withheld entry; rejected draft-date chronology, moved memcon between cable/telegram by event time, filed then stamped to earn Proof Lens. No tool grants or direct scene jumps. Promoted tools/qa-earned-proof.mjs with configurable browser/storage/output paths.
  - Proof Lens, step 5, room S1 and production objective survived reload at reliability 100. Native screenshots inspected under /private/tmp/frus-earned-proof/ (wrong reference, release, chronology rejection, saved production handoff). Browser run captured no page errors. Earned storage is /private/tmp/frus-earned-proof/earned-storage.json.
  - Current full suite: 212 files / 1,625 tests pass; production build passed this continuation cycle with existing chunk-size warning. Movement standard browser smoke passed and native screenshot inspected. Prior turn repeated movement verification without extending progression; this turn advances the earned route and retains reproducible QA.
  - Next: production checks through Buckram Gate and ending from the earned step-5 save; delivery repetition and the wider fun/pacing assessment remain open. No public deployment or whole-game completion claim.

- Earned referral chapter through proofing (2026-09-13):
  - Played the saved Clearance Token handoff through R1 equity batch, carried StateChat manifest, north Dispatch Stacks, receipt recovery via side aisle, crank-opened central return shortcut, then returned to the human desk. Initial harness tried walking through the CIA desk; routed around its clear south aisle instead. No runtime bug established there.
  - At the manifest board, submitted the uncorrected draft (rejected), changed WH Minutes from CIA to NSC using recovered dispatch evidence, and filed separately. Completed three treatment deliveries, physically entered R2, collected Concurrence Slip, and crossed into SilentReadScene with reliability 100. A harness initially asserted legacy referralGateOpen rather than canonical referralPhysicalReviewComplete; corrected assertion. Also routed around NSC desk on the outer aisle, not through its collision box.
  - Native dispatch/shortcut, rejected/corrected manifest, slip and proof arrival screenshots inspected under /private/tmp/frus-earned-referral/ and /private/tmp/frus-earned-manifest/. Both browser runs captured no page errors and export earned storage; latter is the proofing handoff. Promoted tools/qa-earned-referral-dispatch.mjs and tools/qa-earned-referral-manifest.mjs, requiring an earned input save. No runtime edits this turn; prior build/test result not rerun or broadened.
  - Design evidence: source recovery plus shortcut plus draft correction works better than delivery-only stations. Next inspect proofing's conspicuous empty bottom panel and play its editor draft/Red Pencil challenge. Local only, no whole-game completion or unaided human-fun claim.

- Earned Clearance Token and vault save (2026-09-13):
  - Resuming last turn's N2 runtime arrival actually restored N1: NetworkScene also omitted internal-room autosave. Added save after destination/spawn apply and controls unlock plus callback-order unit test. Audited all transitionArchiveRoom callers: Archive already saves, Referral saves after applying destination, SilentRead saves on completion; no other changes needed. Strengthened routing browser QA with reload, N2 assertion and actual resumed movement; passed at /private/tmp/frus-network-vault-save/.
  - Played verified N2 save: take review batch, file Human/Release stations, reject missing withheld memo, arrange it between 09:00 cable and 15:00 telegram using 11:00 conversation time, file separately, physically collect Clearance Token, walk through token-gated east exit to ReferralVaultScene. No debug grants/state changes, no page errors. Native corrected ledger/token/referral screenshots inspected at /private/tmp/frus-earned-clearance/; earned-storage.json is next handoff. Promoted tools/qa-earned-clearance.mjs.
  - 212 files / 1,625 tests and build pass (existing size warning). Standard browser client passed at /private/tmp/frus-vault-save-client/ and native capture inspected. Local only. Next: assess Referral Vault's equity/referral challenge and next tool; the early delivery-only stations remain less interesting than the physical gates and chronology decision, so later pacing work should consider that contrast.
...
- Earned annotation puzzle and room persistence (2026-09-13):
  ...
  - Full suite: 210 files / 1,618 tests pass. Production build passes with existing chunk warning. Local changes only; next playtest should file the earned packet and assess the next exploration reward.

- Doorway movement refinement (2026-09-13):
  - Preserved immediate start/stop/reversal, normalized open diagonals, and full-speed wall sliding. Increased nearest-edge corner guidance from 3 to 4 logical pixels and resolved fractional clearance before lateral movement, preventing nearly aligned doorway approaches from steering a whole extra pixel sideways. Long walls and blocked corners remain solid; no save/input changes.
  - Added fractional-edge cases at 30/60/120 FPS and quarter-tile guidance cutoff coverage. 51 focused movement tests and production build pass (existing bundle-size warning). Standard browser client exercised Office cardinal/diagonal movement, reversal and release; native screenshot inspected at /private/tmp/frus-player-client-native/native.png, state/errors artifacts at /private/tmp/frus-doorway-movement/. No captured browser errors. Physical-phone feel remains unverified. Existing Archive room-save edits left intact and outside this change. Local only.
...
- Gate-caption readability (2026-09-12):
  ...
  - These are debug-entry rendering checks, not a newly earned campaign run or proof of fun. Next: assess whether abbreviated lock labels communicate the requirement clearly during actual approaches. Local only.
...
- OpenNet document matching (2026-09-08):
  ...
  - Final follow-up: centered-label build is 2,785.42 KB (+4.20 KB), still 1,347 passing tests. Full touch-safe replay reaches Black Vault at 201 points / 98 reliability / no standards findings; keyboard ends 201 / 100. D-pad/A/B-only pin, cancel, reopen and file pass without swinging. Further screenshot review caught A's larger invisible hit-zone overlap; final tests cover full A/B/Start/Select rectangles rather than centers. Fourteen scene/pause/map checks pass before final label-only centering; that final rendering is checked by the installed client.
  - Evidence and reproduction: docs/OPENNET_CROSS_REFERENCE.md. Goal active. Continue assessing actual novice pacing and remaining repeated quiz-like checks; this is one meaningful research interaction, not whole-game completion. Local only.
...
- Clear physical Editor handoff (2026-09-08):
  ...
  - Full suite: 183 files / 1,314 tests pass, seven new cases. Production build passes: 245 modules / 2,780.14 KB main JS (+2.20 KB), existing chunk warning. Complete earned-save keyboard and 375x667/DPR-3 touch E1 -> S1 -> Black Vault replays each earn 87 points, finishing at 201 points / 100 reliability, no standards findings or browser errors. Continue, partial repairs, cancel, wrong choices, explicit filing/stamping, all three tool rewards and backtracking pass. Each replay records 37 screenshots and 26 feedback/player overlap checks.
  - Fourteen scene/pause/map checks pass. Installed client movement/A opens Priya's hint; actual compositor/native screenshots inspected. Its direct WebGL capture is black. The client's longer boot/idle wait let DANN-E deal two points of damage; this is distinct from the full no-damage routes. Touch p99 20 ms / isolated 82 ms frame is not locked-60 or real-Safari certification.
  - Evidence and reproduction: docs/EDITOR_E1_TILEMAP.md; three retained before/after/touch screenshots. Final runs: /private/tmp/frus-editor-{keyboard,touch,required-client,scenes}-final-0908. Local only; no push/deployment. Broad goal active. Next: make Editor/proof furniture physical and correctly depth-sorted, verify DANN-E's north patrol against those solids, then continue full-route novice pacing and reduce repeated workstation travel. This handoff is clearer; the whole game is not declared finished.

- Physical Referral workstations (2026-09-08):
  - Preserved a real pre-change save inside CIA at (61,130). Replaced fixed-depth floating panels with native 32x16 desks, front-edge sorting and actual solids across agency, manifest and treatment layouts. Old affected saves recover onto clear floor; valid positions, packets, human decisions, rewards and schema are unchanged. Smaller floor cues use clear authored aisles; the R1 prompt clears the player frame. DANN-E's patrol clears furniture/walls and bolts stop at solids.
  - Full suite: 183 files / 1,307 tests pass. Production build passes, 245 modules / 2,777.94 KB main JS (+2.37 KB), existing chunk warning. Twelve new cases cover all layouts, every integer desk-interior save position, player routes and the complete enemy-body patrol. An unrestricted final run hit three fork-worker startup timeouts; unchanged final source passes with --pool=threads --maxWorkers=2 in 9.50 seconds. Earlier unrestricted full runs passed; no tests weakened.
  - Complete keyboard and 375x667/DPR-3 touch Referral replays reach Editor at 114 points / 100 reliability with Concurrence Slip and no standards findings. Wrong desks, carried/review Continue, stacks discovery/shortcut, editable human filing, reward and backtracking pass. QA walking now follows real aisles; corrected two obsolete targets (inside a new desk edge and the final doorway step) rather than bypassing collision or granting progress.
  - Actual older-save recovery, all three desk approaches, prompt clearance, far-side depth and missing-art fallback pass. Final touch/fallback observers record all six DANN-E waypoints with zero solid overlaps. Touch combat: zero phantom hits, two real contacts, 111 close non-contact frames and an earned Stamp counter while holding D-pad/B. Fourteen scene/pause/map checks pass. Native/compositor screenshots inspected, with no page/console errors. Required-client compositor shows the formerly hidden compiler clearly.
  - Evidence/reproduction: docs/REFERRAL_FURNITURE.md and three retained screenshots. Final runs: /private/tmp/frus-referral-furniture-{keyboard,touch}-final-0908, frus-furniture-patrol-{touch,fallback}-final-0908, frus-furniture-{contact,client,scenes}-final-0908. Local only; goal active. Next: crowded Editor entry card, full-route novice pacing, remaining repetitive desk travel and real-iPhone Safari. This is a physically clearer room, not proof that the entire adventure is finished.

- DANN-E contact fairness (2026-09-08):
  - Resumed the stopped real-input baseline and confirmed a false contact hit: player (88,162), DANN-E (69,147), separated collision rectangles, reliability 91 -> 90. Replaced the 25-pixel damage radius with the actual Player terrain-footprint vs enemy-body intersection. Active counters still resolve before contact; damage values, bolts, cooldowns, pauses, doorway grace, quiet rooms, documents and saves are unchanged.
  - Added 15 regression cases for side/diagonal near misses, one-pixel overlaps, touching edges and contact cooldown. The five near-miss cases failed on the old code. Corrected the Phaser test double to match the engine's inclusive rectangle edges. Full suite passes: 182 files / 1,295 tests. Build passes: 244 modules, main JS 2,775.57 KB (+0.09 KB), existing chunk warning only.
  - Keyboard and 375x667/DPR-3 touch replays each show zero phantom damaging contacts, one deliberate damaging contact, and an earned Citation Stamp stun. Touch tests simultaneous D-pad/B and records 203 nearby non-contact frames. Document candidates, points and standards remain unchanged. tools/qa-danne-contact.mjs records pre-knockback geometry and same-frame reliability without changing gameplay state.
  - Full Referral keyboard regression reaches Editor with 114 points, 100 reliability, Concurrence Slip and zero standards findings, including mistakes, carried-state reloads, physical Dispatch Stacks discovery/shortcut, explicit human review, reward and backtracking. Fourteen scene/pause/map smoke checks pass. Required-client native/compositor screenshots inspected; its direct WebGL buffer capture remains black. No browser errors.
  - Evidence and reproduction in docs/COMBAT_PRESSURE_FAIRNESS.md. Temporary runs: frus-contact-{before,desktop-fixed,touch-final,required,scenes}-0908 and frus-referral-contact-regression-0908. Local only; broad adventure goal remains active. No real-Safari, frame-latency or full optional-world certification.
  - Next verified issue: the compiler disappears behind the CIA station around (53,150) in the required-client capture. Referral agency/review station containers use fixed depth 150 and lack physical furniture footprints. Reconcile collision and Y-sort without narrowing approaches or changing workflow requirements; replay routing on keyboard/touch afterward. The Editor arrival card also looks crowded. Keep pursuing physical exploration/readability, not another general rendering overhaul.

- Actual device-pixel scaling and touch rotation (2026-09-08):
  - Corrected the previous entry's interpretation: 1.333 CSS zoom at DPR 3 is intentionally four physical pixels, not itself a fault. Reproduced actual bugs: DPR 2.625 rounded to 3 gave alternating 3/4-pixel checker cells with a false PASS; centered canvas origins could soften edges; fractional CSS layout widths distorted the far-corner diagonal even with a clean origin checker.
  - Kept the 256x240 logical/backing buffer, native assets and gameplay. One layout now uses actual DPR and safe-area bounds. A translated compositor shell snaps the origin; the native-sized CSS canvas scales in the compositor, avoiding pre-rasterization width rounding. Phaser pointer bounds/displayScale follow the actual rectangle. Density changes without resize are detected; resize correction is synchronous and re-entry guarded. Readouts measure both axes and origin rather than rounded-DPR arithmetic.
  - Production build passes: 244 modules, main JS 2,775.48 KB (+0.62 KB from 37a63a7; existing chunk warning only). Full suite passes 182 files / 1,280 tests. Earlier runs hit worker-start/async timeouts during heavy activity; rerunning the unchanged suite alone passed in 7.78 seconds. No tests weakened or unrelated boss changes made.
  - Final tools/qa-pixel-scale.mjs passes 28 cases and 303,183 exact native-to-compositor pixel comparisons, including the complete origin checker/single texel/far diagonal, portrait/landscape/return, asymmetric safe areas, viewport-height shrink and live DPR changes. Six profiles cover DPR 1, 1.25, 2, 2.625 and 3. Screenshot capture and emulation must share a CDP session; using different sessions produced misleading screenshot scales, now explicitly checked. Evidence: docs/mobile/device-pixel-results.json and four retained screenshots; contract and reproduction notes in RENDERING.md and docs/mobile/device-pixel-scaling.md.
  - Pixel 412x915/DPR2.625 touch replay rotates the actual open ledger, edits/cancels/reloads/files the draft, takes the Clearance Token and enters Referral. Review keeps reliability at 93; ordinary travel can still incur DANN-E damage (84 at the final exit on one replay), so novice touch movement/pressure remains a separate pacing priority. No save, room graph, input mapping semantics, art, or gameplay-state changes.
  - Final small-iPhone touch/rotation and desktop mouse replays both reach Referral at reliability 93; fourteen scene/pause/map routes pass with no page/console errors. Required-client headed replay shows the real correct-but-unfiled draft (slot 2, reliability 93); inspected its compositor capture. Evidence: /private/tmp/frus-pixel-{iphone,mouse,scenes,client}-final-0908, plus the Pixel run above.
  - Local only; broad adventure/fun goal remains active. Real Safari, hardware density switching, pinch zoom and frame/latency certification remain unverified. Next: whole-game novice pacing, Referral/Editor exploration, novice touch movement/pressure and visual coherence. Do not mistake pixel-proof success for game completion.

- Editable withholding chronology (2026-09-08):
  - Replayed Network from the earned Archive exit and replaced the final ClassNet two-answer question with a short ordering puzzle. Insert the wholly withheld memcon between the cable and telegram using conversation time, not its next-day drafting date. Heading, fictional source note and withheld-page count remain visible; filing accounts for withholding and never releases its text. Source: the actual frus1989-92v31 About the Series methodology.
  - Left/right moves the entry; keyboard selection and mouse/touch FILE ENTRY explicitly submit. Wrong drafts give hints without penalties. Every placement persists via optional numeric sceneProgress.classNetWithholdingSlot, with no schema change. Correct-but-unfiled drafts remain unfinished. Reading freezes player, weapons and DANN-E. Closing consumes input. Existing completed saves and the original reward/route remain intact.
  - 182 files / 1,265 tests and production build pass (244 modules; main JS 2,774.86 KB; +4.92 KB, existing chunk warning). Full keyboard and 375x667/DPR-3 touch Network replays reach Referral via the earned stamp crossing, mistakes, reloads, puzzle and token. Focused keyboard/mouse/touch and old-completed-save returns pass. An edge-tap assertion caught Phaser retaining the original small hit areas; custom areas must be registered before bindPointerDown. Final off-center mouse/touch replays pass with non-overlapping 44x44-native targets. Fourteen scene/pause-map routes pass. No page/console errors. Required-client native/compositor captures inspected; direct WebGL-buffer capture remains black. Evidence: /private/tmp/frus-chronology-*; replay tools/qa-network-ledger.mjs adds --ledger-only, --pointer and --completed-return. Details: docs/CLASSNET_WITHHOLDING_LEDGER.md.
  - Local only. Goal stays active, not whole-game completion. Newly measured next priority: mobile CSS canvas 341.328x320 at 375x667/DPR-3, computedZoom 1.333313 despite integerZoom true and a 256x240 backing buffer. Repair the rendering/readout disagreement separately, then verify real Safari. Full touch routing also takes more incidental DANN-E damage than keyboard; test novice movement/pressure without conflating simulator overhead with difficulty. Continue Referral/Editor pacing and visual coherence.

- Annotation Stacks discovery room (2026-09-08):
  - Replaced the repeated A1 annotation-desk lap with separate AS: three connected reading aisles, a real two-tile north doorway after stamping NO REPO, and an unconditional south return to the research table. Gathered notes still require the original explicit human coverage review; no automatic filing, added rewards, or changed documents. The onward NARA door opens after filing; its return uses new ordinal 13 without renumbering old rooms.
  - Reused packed native interior tiles: floors 4/3/0/6, wall 8, shelf 19. Missing-texture fallback shares exact collision cells. Screenshots caught an overly tight pickup radius, note cards over the player, a low-contrast entry title, map/door direction disagreement, and a completed-packet return cue pointing back into the stacks; all corrected. AS is a quiet discovery beat; other rooms retain DANN-E pressure.
  - Keyboard and 375x667/DPR-3 simulated touch replays reach Network with the unchanged 55 points, including early north-gate rejection, partial Continue, pause, blocked unfiled NARA exit, carried return, and explicit table filing. Partial-packet round-trips, fallback shelf collision, and old completed-save NARA returns preserve inventory/documents/rewards. Fourteen scene/pause/map smoke routes pass without page/console errors. Required-client native/compositor screenshots inspected; its direct WebGL capture remains black headed and headless.
  - 181 files / 1,244 tests and production build pass (242 modules; main JS 2,769.94 KB; existing chunk warning). Replay tools: qa-archive-wall.mjs [--mobile] and qa-annotation-stacks-safety.mjs. Details and retained screenshots: docs/ANNOTATION_STACKS.md. Evidence: /private/tmp/frus-annotation-stacks-keyboard-release, frus-annotation-stacks-touch-final, frus-annotation-stacks-safety-final, frus-annotation-required-release-retry and frus-annotation-stacks-scene-smoke-release. One required-client navigation timed out before loading; the preview responded normally and the isolated retry passed on the unchanged build.
  - Local only; no public deployment or whole-game quality claim. Broad goal remains active: improve meaningful document-puzzle variety, remaining source-art seams and mixed sprites, uninterrupted novice pacing, and real iPhone Safari.

- Teachable counter cavern and real room bounds (2026-09-06):
  - Replayed the opening and reproduced a wrong-facing swing prompt plus movement completely outside the painted Guide walls, to (242,220). Added guide-only facing/wait/swing/recovery cues that predict overlap during the existing Citation Stamp active window, with a floor reach outline. The player still makes the timed swing; A alone, wrong facing and static swings do not clear training. No changes to input, weapon timings, boss damage, rewards or save schema.
  - Guide now uses the existing packed native 7-column archive sheet, with four sparse floor variants (0/5/1/2), wall 8, corners 7 and torches 21. Screenshot review rejected later fill tiles whose bottom shading formed stripes. Old SVG/rectangle rendering remains guarded fallback. Matching feet bounds x40..216/y70..180 contain the player; old outside-wall saved positions clamp on entry without changing earned progress.
  - Fresh keyboard and 375x667/DPR-3 touch openings reach Archive at 20 points / 80 starting reliability, including walls, harmless miss, wrong-facing swing, pause, counter by displayed cues from the pickup location, fragment and Continue. Isolated earned-save tests cover an old outside position and removed native texture; both retain inventory/rewards and exit to Archive. No page/console errors. Required client exercised pickup/facing feedback headed and headless; direct WebGL captures remain black, while native/compositor screenshots were inspected.
  - 180 test files / 1,237 tests and production build pass (241 modules; main JS 2,765.76 KB, existing chunk warning). Fourteen final scene/pause/map smoke routes pass without page/console errors. Replay tools: qa-guide-counter.mjs --coaching [--mobile] and qa-guide-room-safety.mjs. Updated docs/GUIDE_CAVERN_ONBOARDING.md and retained three screenshots. Evidence: /private/tmp/frus-guide-final-desktop, frus-guide-release-touch, frus-guide-required-release, frus-guide-room-safety-release, frus-guide-release-scene-smoke.
  - Local only; public deployment unchanged. Broad goal remains active: next assess uninterrupted early-chapter pacing and discovery, remaining repeated desks, older character-art consistency, and actual iPhone Safari. This is a clearer first reusable adventure skill, not proof that the whole game meets the fun/quality bar.

- Dispatch Stacks evidence trip (2026-09-06):
  - Added separate Referral R3 through R1's north Clearance Token door. Two three-tile side aisles reach a fictional training dispatch copy; a far-side crank opens a two-tile return aisle. This quiet room pauses/hides DANN-E while retaining normal pressure in R1/R2. Reused native interior tiles with sparse floor variation; actual and fallback collision agree.
  - The copy supplies WH Minutes -> NSC evidence beside the StateChat draft. Filing an unreviewed manifest requires finding the copy, correcting the route, and explicitly filing at the human desk. It never changes the draft or approves release automatically. Existing completed saves are not reopened; no new rewards, inventory or save schema. Two sceneProgress flags persist discoveries.
  - Fixed carried equity/treatment icons disappearing on early/late room visits and removed generic phantom furniture from the missing-texture fallback. Short objectives, localized quiet-room cues, and the pause map now reflect R3.
  - Earned desktop and 375x667/DPR-3 touch replays both finish Referral -> Editor at 114 points / 100 reliability, including early/late carry, Continue, closed shelves, both side aisles, crank, draft cancel/reload/correction and all original treatment dockets. Old completed-save backtracking and no-crank/fallback return checks pass. Required-client input opens/walks the center aisle; native/compositor screenshots inspected (direct WebGL captures remain black). Fourteen scene/pause/map smoke routes pass without page/console errors.
  - 178 test files / 1,228 tests and production build pass (239 modules, main JS 2,761.96 KB; existing chunk warning). Replay tools: qa-referral-manifest.mjs and qa-referral-dispatch-safety.mjs; retained evidence and limits in docs/REFERRAL_DISPATCH_STACKS.md. One mobile QA attempt overlapped a dist rebuild and failed on a removed hashed resource; final stable-build replay passes. Do not rebuild dist while a browser replay reloads it.
  - Broad goal remains active: next assess uninterrupted first-time pacing and encounter variety, reduce remaining desk repetition, improve art consistency, and verify real iPhone Safari. Local only; public deployment unchanged.

- Network physical stamp crossing (2026-09-06):
  - Replaced N1's two non-solid wall figures with a real tile divider and optional service crossing. File the first public packet, then hit the seal with an owned Citation Stamp during active swing frames. The reward is a direct walk between the terminals; the lower two-tile route remains available and the four routing packets / three human-review dockets remain mandatory. No added points or release authorization.
  - Persisted one sceneProgress flag, retained old completed routes, and moved only old spawns overlapping the divider. Route hints now follow the crossing/detour below entities. DANN-E patrols around the new geometry; Network bolts stop at room solids. Fallback rendering and collision agree.
  - Desktop and 375x667/DPR-3 touch replays start from earned Archive progress and reach Referral Vault, including seal prerequisite, active swing, pause, Continue, wrong-network recovery and human withholding review. The detour-only replay also completes. Synthetic old-position and missing-texture fixtures pass. Screenshot inspection caught the opened corridor still resembling a wall; matching floor tiles now show the gap clearly.
  - 177 test files / 1,222 tests and production build pass (238 modules, main JS 2,755.20 KB; existing chunk warning). Required-client direct WebGL captures remain black headless/headed; actual native/compositor views inspected. Details/replay paths: docs/NETWORK_STAMP_CROSSING.md and tools/qa-network-ledger.mjs --crossing [--mobile]. Local only.
  - Broad goal remains active. Next: a compact exploration/clue room with a meaningful return route; reduce remaining desk repetition, check real iPhone Safari, and keep all expression original.

- Combat pressure fairness and fresh critical-path completion (2026-09-06):
  - Reproduced Archive wall contact creating a permanent missed-30-year-deadline entry before any statutory clock started. Both wall contact and GameplayMapScene enemy hits now keep their original four-point reliability damage without changing the record. Continue repairs only nine exact old collision contexts; audit entries, counts, loss, documents and rewards remain. Real deadlines, document-scoped findings and other violations still block certification. Restoration no longer repeats the false deadline message.
  - Touch QA exposed stationary diagonal Mark I Ego bolts: (74,78) did not move across 1.4 seconds despite nonzero velocity. Expansion projectiles now retain precise coordinates and reuse the final boss integrator, snapping only the visual/hitbox. Tests cover 30/60/120/144 fps and single-hit removal; timings, speed, lifetime, room clear and enemy HP are unchanged.
  - Fresh checkpointed earned desktop chain completed opening -> Guide -> Archive -> Network -> Referral -> proof -> all three DANN-E phases -> publication, at 241 points / five pieces / 100 reliability / zero outstanding findings, then Continue without duplicate rewards. Boss used eight counter cycles, no retries and no missed deadline. Touch independently completes the same earned bindery. This is not uninterrupted human pacing measurement or a complete mobile fresh run.
  - 176 files / 1,215 tests and production build pass (237 modules, main JS 2,751.20 KB; existing chunk warning). Desktop and 375x667/DPR-3 touch replays verify real wall/bolt hits, pause, Continue, and a real pre-fix contact save. Fourteen scene/pause/map routes pass without page/console errors. Required-client direct-buffer images remain black headed/headless; native/compositor screenshots inspected. Three screenshots retained.
  - Replay: tools/qa-process-pressure.mjs; evidence/limits: docs/COMBAT_PRESSURE_FAIRNESS.md and /private/tmp/frus-pressure-* / frus-fresh-pacing-*. Local only. Next: reduce repeated middle-chapter desk trips through physical tool puzzles and exploration rewards; audit other rounded motion paths, older art and actual iPhone Safari. Broad fun/adventure goal remains active.

- Editable withholding indications and completed-record recheck (2026-09-05):
  - Reproduced the completed Editor Desk ignoring a missing bracket after returning from the bindery. The regression injects a lost-bracket fault into an earned 217-point pending-seal save; it is explicitly not an earned gameplay mistake. Replaced the first-time bracket quiz with an editable proof and added a two-tool return loop: Editor Desk/Red Pencil -> carried corrected proof -> Proof Table/Proof Lens -> the same pending seal.
  - Fictional retained notes support exactly two known records. Draft and proof filing are separate human actions; incomplete filing only hints, and repeat taps do not grant credit. Preserves citation/source metadata, agency responses, other standards violations, inventory, reliability, chapter rewards and boss counts. Published records cannot be silently rewritten. Optional deep-cloned repair metadata uses the existing save system. Opening the recheck now saves the station position after the required-client replay exposed a stale-entry Continue bug.
  - Desktop and 375x667/DPR-3 simulated touch complete draft/cancel/Continue/reproof/return/publication, staying at 217 points until the original remaining rewards reach 241. First-time desktop/touch still complete all eight review tasks for exactly 87 points. Threats freeze during review; cancel does not swing; repeated publication Continue retains final stats. Screenshot inspection caught the generic Choose Answer HUD cue; repair/recheck now use localized Review Record.
  - 175 files / 1,193 tests and production build pass (237 modules; main JS 2,750.48 KB; existing chunk warning). Required-client headed/headless runs file the proof and show correct state; direct WebGL-buffer PNGs remain black, while inspected native/compositor images show actual gameplay. Replay/evidence: tools/qa-editorial-repair.mjs, tools/qa-proof-comparison.mjs, docs/EDITORIAL_REPAIR_LOOP.md, /private/tmp/frus-editorial-repair-publish-final, /private/tmp/frus-editorial-repair-publish-touch-final and /private/tmp/frus-editorial-first-{playthrough,touch}.
  - Final verification also rejects an actual attempted early seal and names the Editor Desk in the touch HUD; the same touch run then repairs and publishes. Fourteen scene/pause/map routes pass without page/console errors (/private/tmp/frus-editorial-final-scene-smoke). Four retained before/repair/recheck/blocked-seal screenshots document the loop. Local only. Next: fresh whole-game pacing and onboarding, other evidence-specific damaged-record cases, older art consistency, and real iPhone Safari. The broad fun/adventure goal remains active.
