...
export const FRUS_PRODUCTION_PHASES = [
  ...
  },
  {
    ...
    shortLabel: "RSCH",
    sourceBasis: "Secure access, file the scope charter, collect records, map repository coverage, select the printed subset, audit policy coverage, verify sources, and draft contextual annotation.",
    stepIds: ["records_access", "research_charter", "record_collection", "repository_coverage_map", "research_selection", "policy_coverage_audit", "source_notes", "annotation"]
  },
  {
    id: "clearance",
